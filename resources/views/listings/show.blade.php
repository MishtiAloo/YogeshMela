        ...
        <div class="related-grid">
            ...
            <a href="/listings/{{ $related->id }}" class="related-card">
                <div class="related-image">
                    @if($related->image)
                        @if(str_starts_with($related->image, 'image/'))
                            <img src="{{ asset($related->image) }}" alt="{{ ucfirst($related->animal_type) }}">
                        @else
                            <img src="{{ asset('storage/' . $related->image) }}" alt="{{ ucfirst($related->animal_type) }}">
                        @endif
                    @else
                        <span>{{ ucfirst($related->animal_type) }} Image</span>
                    @endif
                </div>
